...
class CreditorsSection extends ConsumerStatefulWidget {
  const CreditorsSection({super.key, required this.onCreditorTap});

  final ValueChanged<Creditor> onCreditorTap;

  @override
  ConsumerState<CreditorsSection> createState() => _CreditorsSectionState();
}

class _CreditorsSectionState extends ConsumerState<CreditorsSection> {
