...
class DebtorsSection extends ConsumerStatefulWidget {
  const DebtorsSection({super.key, required this.onDebtorTap});

  final ValueChanged<Debtor> onDebtorTap;

  @override
  ConsumerState<DebtorsSection> createState() => _DebtorsSectionState();
}

class _DebtorsSectionState extends ConsumerState<DebtorsSection> {
